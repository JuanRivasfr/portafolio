...
function Home() {
    ...
    const Rocket01Icon = (props) => (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#242424"} fill={"none"} {...props}>
    ...
    return (
            <section id='section-presentacion'  className={`fade-out ${fadeOut ? 'fade-out-active' : ''}`}>
                <div id='container-titulo-descripcion'>
                    <div id='container-about'>
                        <h1 id='h1-aboutme'>Hi! I'm  Juan Rivas </h1>
